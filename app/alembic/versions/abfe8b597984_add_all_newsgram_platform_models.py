"""Add all NewsGram platform models

Revision ID: abfe8b597984
Revises: 1a31ce608336
Create Date: 2025-09-26 11:49:02.174132
...
def upgrade():
    ...
    sa.Column('top_performing_post_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('payout_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('push_service_id', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    ...
    sa.Column('music_id', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    ...
    sa.Column('allow_reactions', sa.Boolean(), nullable=False),
    sa.Column('status', sa.Enum('SCHEDULED', 'LIVE', 'ENDED', 'CANCELLED', 'PROCESSING', name='streamstatus'), nullable=False),
    sa.Column('scheduled_at', sa.DateTime(), nullable=True),
    sa.Column('started_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('priority', sa.Enum('LOW', 'MEDIUM', 'HIGH', 'URGENT', 'BREAKING', name='newspriority'), nullable=False),
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['newstag.id'], ),
    sa.ForeignKeyConstraint(['news_id'], ['news.id'], ),
    sa.PrimaryKeyConstraint('news_id', 'id')
    )
    ...
    op.add_column('user', sa.Column('profile_image_url', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True))
    op.add_column('user', sa.Column('website_url', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True))
    op.add_column('user', sa.Column('location', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True))
    op.add_column('user', sa.Column('account_type', sa.Enum('PERSONAL', 'BUSINESS', 'JOURNALIST', 'ORGANIZATION', name='accounttype'), nullable=False))
    op.add_column('user', sa.Column('is_private', sa.Boolean(), nullable=False))
    op.add_column('user', sa.Column('is_professional_account', sa.Boolean(), nullable=False))
    op.add_column('user', sa.Column('category', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True))
    op.add_column('user', sa.Column('is_journalist', sa.Boolean(), nullable=False))
    ...
    op.add_column('user', sa.Column('gender', sa.Enum('MALE', 'FEMALE', 'OTHER', 'PREFER_NOT_TO_SAY', name='gender'), nullable=True))
    op.add_column('user', sa.Column('follower_count', sa.Integer(), nullable=False))
    op.add_column('user', sa.Column('following_count', sa.Integer(), nullable=False))
    op.add_column('user', sa.Column('post_count', sa.Integer(), nullable=False))
...
def downgrade():
    ...
    op.drop_column('user', 'is_journalist')
    op.drop_column('user', 'category')
    op.drop_column('user', 'is_professional_account')
