...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "model_version", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "metric_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "target_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("target_id", sa.Uuid(), nullable=False),
        sa.Column(
            "anomaly_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("anomaly_score", sa.Numeric(precision=5, scale=4), nullable=False),
        sa.Column(
            "threshold_breached", sa.Numeric(precision=5, scale=4), nullable=False
        ),
        sa.Column(
            "detection_method",
    ...
    op.create_index(
        op.f("ix_anomalydetection_target_id"),
        "anomalydetection",
        ["target_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "meta_title", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "meta_description",
    ...
    op.create_index(
        op.f("ix_contentanalysis_content_id"),
        "contentanalysis",
        ["content_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_contentanalytics_author_id"),
        "contentanalytics",
        ["author_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentanalytics_content_created_at"),
        "contentanalytics",
        ["content_created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentanalytics_content_id"),
        "contentanalytics",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentanalytics_content_type"),
        "contentanalytics",
        ["content_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentanalytics_date_recorded"),
        "contentanalytics",
        ["date_recorded"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentanalytics_id"), "contentanalytics", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "subcategory", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_contentclassification_content_id"),
        "contentclassification",
        ["content_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum("visual", "audio", "text", "transition", name="effectcategory"),
            nullable=False,
        ),
        sa.Column(
            "description", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ...
        sa.Column(
            "preview_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "viral_probability", sa.Numeric(precision=5, scale=4), nullable=False
        ),
        ...
        sa.Column(
            "prediction_accuracy", sa.Numeric(precision=5, scale=4), nullable=True
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_engagementprediction_content_id"),
        "engagementprediction",
        ["content_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "provider", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "media_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "mime_type", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
            "file_format", sqlmodel.sql.sqltypes.AutoString(length=10), nullable=False
        ),
        ...
        sa.Column(
            "quality", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_mediafile_created_at"), "mediafile", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_mediafile_filename"), "mediafile", ["filename"], unique=False
    )
    op.create_index(op.f("ix_mediafile_id"), "mediafile", ["id"], unique=False)
    op.create_index(
        op.f("ix_mediafile_media_type"), "mediafile", ["media_type"], unique=False
    )
    op.create_index(
        op.f("ix_mediafile_user_id"), "mediafile", ["user_id"], unique=False
    )
    op.create_table(
        "mediastorage",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "storage_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "bucket_name", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column("region", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True),
        sa.Column(
            "endpoint_url", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("is_active", sa.Boolean(), nullable=False),
        sa.Column(
            "auto_action", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "artist", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
        ...
        sa.Column(
            "audio_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=False
        ),
        ...
        sa.Column(
            "license_type", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_platformanalytics_date_recorded"),
        "platformanalytics",
        ["date_recorded"],
        unique=False,
    )
    op.create_index(
        op.f("ix_platformanalytics_id"), "platformanalytics", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_platformanalytics_month_start"),
        "platformanalytics",
        ["month_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_platformanalytics_week_start"),
        "platformanalytics",
        ["week_start"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "translated_text", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
        sa.Column(
            "translation_quality", sa.Numeric(precision=3, scale=2), nullable=True
        ),
        sa.Column(
            "translation_service",
            sqlmodel.sql.sqltypes.AutoString(length=50),
    ...
    op.create_index(
        op.f("ix_translationcache_content_id"),
        "translationcache",
        ["content_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column(
            "trend_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "trend_value", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
        ...
        sa.Column(
            "language", sqlmodel.sql.sqltypes.AutoString(length=10), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "topic_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
        ...
        sa.Column("peak_time", sa.DateTime(), nullable=True),
        sa.Column(
            "country_code", sqlmodel.sql.sqltypes.AutoString(length=10), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_trendingtopic_last_updated"),
        "trendingtopic",
        ["last_updated"],
        unique=False,
    )
    op.create_index(
        op.f("ix_trendingtopic_topic"), "trendingtopic", ["topic"], unique=True
    )
    op.create_table(
        "user",
        ...
        sa.Column(
            "account_type",
            sa.Enum(
                "personal", "business", "journalist", "organization", name="accounttype"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_useranalytics_date_recorded"),
        "useranalytics",
        ["date_recorded"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_useranalytics_month_start"),
        "useranalytics",
        ["month_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_useranalytics_user_id"), "useranalytics", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_useranalytics_week_start"),
        "useranalytics",
        ["week_start"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_adcampaign_advertiser_id"),
        "adcampaign",
        ["advertiser_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "churn_probability", sa.Numeric(precision=5, scale=4), nullable=False
        ),
        sa.Column(
            "churn_risk_level",
            sqlmodel.sql.sqltypes.AutoString(length=20),
        ...
        sa.Column(
            "action_result", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_churnprediction_user_id"), "churnprediction", ["user_id"], unique=False
    )
    op.create_table(
        "contentflag",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column(
            "flag_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("confidence_score", sa.Numeric(precision=5, scale=4), nullable=False),
        sa.Column(
            "detected_text",
        ...
        sa.Column(
            "flagged_by", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("status", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(
        op.f("ix_contentflag_content_id"), "contentflag", ["content_id"], unique=False
    )
    op.create_table(
        ...
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column(
            "recommendation_score", sa.Numeric(precision=5, scale=4), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_contentrecommendation_content_id"),
        "contentrecommendation",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentrecommendation_user_id"),
        "contentrecommendation",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column(
            "reason", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            "resolution", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_contentreport_content_id"),
        "contentreport",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_contentreport_reporter_id"),
        "contentreport",
        ["reporter_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("direct", "group", "channel", name="conversationtype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_conversation_creator_id"), "conversation", ["creator_id"], unique=False
    )
    op.create_index(op.f("ix_conversation_id"), "conversation", ["id"], unique=False)
    op.create_index(
        op.f("ix_conversation_last_message_at"),
        "conversation",
        ["last_message_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conversation_title"), "conversation", ["title"], unique=False
    )
    op.create_table(
        "creatorpayout",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("status", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column(
            "payout_method", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_creatorpayout_creator_id"),
        "creatorpayout",
        ["creator_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_creatorpayout_payout_id"), "creatorpayout", ["payout_id"], unique=True
    )
    op.create_table(
        "device",
        sa.Column(
            "device_token", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column(
            "device_type",
            sa.Enum("ios", "android", "web", "desktop", name="devicetype"),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "device_model", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column(
            "os_version", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "app_version", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "status",
        ...
        sa.Column(
            "timezone", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "language", sqlmodel.sql.sqltypes.AutoString(length=10), nullable=True
        ),
        ...
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.Column(
            "push_service", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_device_device_token"), "device", ["device_token"], unique=True
    )
    op.create_index(
        op.f("ix_device_registered_at"), "device", ["registered_at"], unique=False
    )
    ...
    op.create_table(
        "integrationsynclog",
        sa.Column(
            "operation", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_mediaanalytics_date_recorded"),
        "mediaanalytics",
        ["date_recorded"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mediaanalytics_id"), "mediaanalytics", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_mediaanalytics_media_file_id"),
        "mediaanalytics",
        ["media_file_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mediaanalytics_month_start"),
        "mediaanalytics",
        ["month_start"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mediaanalytics_week_start"),
        "mediaanalytics",
        ["week_start"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "job_status", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        ...
        sa.Column(
            "queue_name", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_mediaprocessingjob_created_at"),
        "mediaprocessingjob",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_mediaprocessingjob_id"), "mediaprocessingjob", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_mediaprocessingjob_media_file_id"),
        "mediaprocessingjob",
        ["media_file_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column(
            "action_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_moderationaction_content_id"),
        "moderationaction",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_moderationaction_moderator_id"),
        "moderationaction",
        ["moderator_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "old_value", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "new_value", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_moderationlog_moderator_id"),
        "moderationlog",
        ["moderator_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_moderationlog_target_id"), "moderationlog", ["target_id"], unique=False
    )
    op.create_table(
        "newssource",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "website_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "rss_feed_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "contact_email", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "contact_phone", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "headquarters", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "logo_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "favicon_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        ...
        sa.Column(
            "bias_rating", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "factual_reporting",
            sqlmodel.sql.sqltypes.AutoString(length=50),
        ...
        sa.Column(
            "source_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column(
            "media_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        ...
        sa.Column(
            "api_endpoint", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "push_error", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column("email_sent_at", sa.DateTime(), nullable=True),
        sa.Column(
            "email_error", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_notification_sender_id"), "notification", ["sender_id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "quiet_hours_end", sqlmodel.sql.sqltypes.AutoString(length=5), nullable=True
        ),
        sa.Column(
            "priority_threshold",
            sqlmodel.sql.sqltypes.AutoString(length=20),
    ...
    op.create_index(
        op.f("ix_notificationpreference_id"),
        "notificationpreference",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notificationpreference_user_id"),
        "notificationpreference",
        ["user_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_personalizedfeed_user_id"),
        "personalizedfeed",
        ["user_id"],
        unique=True,
    )
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "caption", sqlmodel.sql.sqltypes.AutoString(length=2200), nullable=True
        ),
        sa.Column("content", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
        sa.Column(
            "summary", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "post_type",
            sa.Enum("regular", "story", "reel", "live", "article", name="posttype"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("draft", "published", "archived", "scheduled", name="poststatus"),
            nullable=False,
        ),
        sa.Column(
            "visibility",
            sa.Enum("public", "followers_only", "close_friends", name="postvisibility"),
            nullable=False,
        ),
        ...
        sa.Column(
            "location_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_post_last_interaction_at"),
        "post",
        ["last_interaction_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_post_scheduled_at"), "post", ["scheduled_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("original", "duet", "stitch", "remix", name="reeltype"),
            nullable=False,
        ),
        sa.Column("title", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
        sa.Column(
        ...
        sa.Column(
            "visibility",
            sa.Enum("public", "friends", "private", name="reelvisibility"),
            nullable=False,
        ),
        sa.Column(
            "video_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=False
        ),
        sa.Column(
            "thumbnail_url",
            sqlmodel.sql.sqltypes.AutoString(length=1000),
        ...
        sa.Column(
            "status",
            sa.Enum("processing", "published", "failed", "deleted", name="reelstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "query", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column(
            "search_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_searchhistory_query"), "searchhistory", ["query"], unique=False
    )
    op.create_index(
        op.f("ix_searchhistory_searched_at"),
        "searchhistory",
        ["searched_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_searchhistory_user_id"), "searchhistory", ["user_id"], unique=False
    )
    op.create_table(
        "searchquery",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_searchquery_created_at"), "searchquery", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_searchquery_id"), "searchquery", ["id"], unique=False)
    op.create_index(
        op.f("ix_searchquery_query"), "searchquery", ["query"], unique=False
    )
    op.create_index(
        op.f("ix_searchquery_user_id"), "searchquery", ["user_id"], unique=False
    )
    op.create_table(
        "socialmediapost",
        sa.Column(
        ...
        sa.Column("content_id", sa.Uuid(), nullable=False),
        sa.Column(
            "post_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column("status", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_index(
        op.f("ix_sponsoredcontent_brand_id"),
        "sponsoredcontent",
        ["brand_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sponsoredcontent_content_id"),
        "sponsoredcontent",
        ["content_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sponsoredcontent_creator_id"),
        "sponsoredcontent",
        ["creator_id"],
        unique=False,
    )
    op.create_table(
        "sportsdata",
        sa.Column(
            "league", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        ...
        sa.Column(
            "event_name", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
        sa.Column("external_id", sa.Uuid(), nullable=False),
    ...
    op.create_table(
        "stockdata",
        sa.Column(
            "symbol", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False
        ),
        sa.Column(
            "company_name", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=False),
        sa.Column(
            "type", sa.Enum("photo", "video", "text", name="storytype"), nullable=False
        ),
        sa.Column(
            "media_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=False
        ),
        sa.Column(
            "thumbnail_url",
            sqlmodel.sql.sqltypes.AutoString(length=1000),
        ...
        sa.Column(
            "text_content", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column("text_position_x", sa.Float(), nullable=True),
        sa.Column("text_position_y", sa.Float(), nullable=True),
        sa.Column(
            "text_color", sqlmodel.sql.sqltypes.AutoString(length=7), nullable=True
        ),
        ...
        sa.Column(
            "interactive_type", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("interactive_data", sa.JSON(), nullable=True),
        sa.Column("music_id", sa.Uuid(), nullable=True),
        sa.Column(
            "music_title", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "music_artist", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column("music_duration", sa.Integer(), nullable=True),
        sa.Column(
            "filter_name", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column("effect_data", sa.JSON(), nullable=True),
        sa.Column(
            "visibility",
            sa.Enum("public", "close_friends", "private", name="storyvisibility"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("active", "expired", "deleted", name="storystatus"),
            nullable=False,
        ),
        sa.Column("expires_at", sa.DateTime(), nullable=False),
        sa.Column("scheduled_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_storyhighlight_id"), "storyhighlight", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_storyhighlight_user_id"), "storyhighlight", ["user_id"], unique=False
    )
    op.create_table(
        "stream",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "visibility",
            sa.Enum("public", "private", "unlisted", name="streamvisibility"),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "playback_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "thumbnail_url",
            sqlmodel.sql.sqltypes.AutoString(length=1000),
        ...
        sa.Column(
            "quality",
            sa.Enum("low", "medium", "high", "ultra", name="streamquality"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("scheduled", "live", "ended", "cancelled", name="streamstatus"),
            nullable=False,
        ),
        sa.Column("scheduled_at", sa.DateTime(), nullable=True),
        sa.Column("started_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_subscriptiontier_creator_id"),
        "subscriptiontier",
        ["creator_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_userban_banned_by"), "userban", ["banned_by"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_userbehavior_target_id"), "userbehavior", ["target_id"], unique=False
    )
    op.create_index(
        op.f("ix_userbehavior_user_id"), "userbehavior", ["user_id"], unique=False
    )
    op.create_table(
        "userstrike",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_userstrike_issued_by"), "userstrike", ["issued_by"], unique=False
    )
    op.create_index(
        op.f("ix_userstrike_user_id"), "userstrike", ["user_id"], unique=False
    )
    op.create_table(
        "weatherdata",
        sa.Column(
            "location", sqlmodel.sql.sqltypes.AutoString(length=200), nullable=False
        ),
        sa.Column(
            "temperature_celsius", sa.Numeric(precision=5, scale=2), nullable=False
        ),
        sa.Column(
            "temperature_fahrenheit", sa.Numeric(precision=5, scale=2), nullable=False
        ),
        ...
        sa.Column(
            "condition", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
        sa.Column(
            "icon_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=True),
        sa.Column(
            "impression_type", sqlmodel.sql.sqltypes.AutoString(), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_adimpression_campaign_id"),
        "adimpression",
        ["campaign_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_adimpression_user_id"), "adimpression", ["user_id"], unique=False
    )
    op.create_table(
        "apirequestlog",
        sa.Column(
        ...
        sa.Column(
            "endpoint", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False
        ),
        sa.Column(
            "ip_address", sqlmodel.sql.sqltypes.AutoString(length=45), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "evidence", sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True
        ),
        sa.Column("status", sqlmodel.sql.sqltypes.AutoString(), nullable=False),
        sa.Column("reviewed_by", sa.Uuid(), nullable=True),
        sa.Column("reviewed_at", sa.DateTime(), nullable=True),
        sa.Column(
            "review_notes", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_banappeal_appellant_id"), "banappeal", ["appellant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_creatorearning_creator_id"),
        "creatorearning",
        ["creator_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "content", sqlmodel.sql.sqltypes.AutoString(length=10000), nullable=True
        ),
        sa.Column(
            "media_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "media_type", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_moderationappeal_action_id"),
        "moderationappeal",
        ["action_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_moderationappeal_appellant_id"),
        "moderationappeal",
        ["appellant_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "headline", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "subheadline", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "lead_text", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "location_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "medium", "high", "breaking", name="newspriority"),
            nullable=False,
        ),
        sa.Column(
            "original_url", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "author_name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        sa.Column(
            "author_email", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        ...
        sa.Column(
            "fact_check_summary", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("credibility_score", sa.Float(), nullable=True),
        sa.Column(
            "meta_title", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "published", "archived", "scheduled", name="newsstatus"),
            nullable=False,
        ),
        sa.Column(
            "visibility", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        sa.Column("scheduled_at", sa.DateTime(), nullable=True),
        sa.Column("published_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_news_fact_check_status"), "news", ["fact_check_status"], unique=False
    )
    op.create_index(op.f("ix_news_id"), "news", ["id"], unique=False)
    op.create_index(
        op.f("ix_news_is_breaking_news"), "news", ["is_breaking_news"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_news_last_interaction_at"),
        "news",
        ["last_interaction_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_news_scheduled_at"), "news", ["scheduled_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "processing_error", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
        sa.Column("sort_order", sa.Integer(), nullable=False),
        sa.Column(
            "alt_text", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "caption", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_postmedia_post_id"), "postmedia", ["post_id"], unique=False
    )
    op.create_table(
        "searchresult",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_searchresult_query_id"), "searchresult", ["query_id"], unique=False
    )
    op.create_table(
        "storyinteraction",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_storyinteraction_id"), "storyinteraction", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_storyinteraction_interaction_type"),
        "storyinteraction",
        ["interaction_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_storyinteraction_story_id"),
        "storyinteraction",
        ["story_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_storyinteraction_user_id"),
        "storyinteraction",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "device_type", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "ip_address", sqlmodel.sql.sqltypes.AutoString(length=45), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_storyviewer_story_id"), "storyviewer", ["story_id"], unique=False
    )
    op.create_index(
        op.f("ix_storyviewer_user_id"), "storyviewer", ["user_id"], unique=False
    )
    op.create_table(
        "streambadge",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "badge_type",
            sa.Enum(
                "heart", "star", "diamond", "fire", "rocket", "crown", name="badgetype"
            ),
        ...
        sa.Column(
            "message", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        ...
        sa.Column(
            "sound_effect", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_streambadge_sender_id"), "streambadge", ["sender_id"], unique=False
    )
    op.create_index(
        op.f("ix_streambadge_stream_id"), "streambadge", ["stream_id"], unique=False
    )
    op.create_table(
        "streamviewer",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "role",
            sa.Enum("viewer", "moderator", "host", name="viewerrole"),
            nullable=False,
        ),
        sa.Column("is_muted", sa.Boolean(), nullable=False),
    ...
    op.create_index(
        op.f("ix_streamviewer_stream_id"), "streamviewer", ["stream_id"], unique=False
    )
    op.create_index(
        op.f("ix_streamviewer_user_id"), "streamviewer", ["user_id"], unique=False
    )
    op.create_table(
        "usersubscription",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_usersubscription_tier_id"),
        "usersubscription",
        ["tier_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_usersubscription_user_id"),
        "usersubscription",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        "webhookdelivery",
        sa.Column(
            "event", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("member", "admin", "owner", name="participantrole"),
            nullable=False,
        ),
        sa.Column(
            "status",
            sa.Enum("active", "muted", "banned", "left", name="participantstatus"),
            nullable=False,
        ),
        ...
        sa.Column(
            "nickname", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "theme_preference",
            sqlmodel.sql.sqltypes.AutoString(length=50),
    ...
    op.create_index(
        op.f("ix_conversationparticipant_conversation_id"),
        "conversationparticipant",
        ["conversation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conversationparticipant_id"),
        "conversationparticipant",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_conversationparticipant_user_id"),
        "conversationparticipant",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "medium", "high", "urgent", name="factcheckpriority"),
            nullable=False,
        ),
        ...
        sa.Column(
            "verdict", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True
        ),
        ...
        sa.Column("reviewed_at", sa.DateTime(), nullable=True),
        sa.Column(
            "review_status", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False
        ),
        ...
        sa.Column(
            "jurisdiction", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_factcheck_news_id"), "factcheck", ["news_id"], unique=False
    )
    op.create_index(op.f("ix_factcheck_status"), "factcheck", ["status"], unique=False)
    op.create_index(
        op.f("ix_factcheck_user_id"), "factcheck", ["user_id"], unique=False
    )
    op.create_table(
        "newsrelated",
        sa.Column("news_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_payment_payment_id"), "payment", ["payment_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_factcheckcomment_fact_check_id"),
        "factcheckcomment",
        ["fact_check_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_factcheckcomment_id"), "factcheckcomment", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_factcheckcomment_user_id"),
        "factcheckcomment",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_premiumfeaturepurchase_feature_id"),
        "premiumfeaturepurchase",
        ["feature_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_premiumfeaturepurchase_user_id"),
        "premiumfeaturepurchase",
        ["user_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_premiumfeaturepurchase_user_id"), table_name="premiumfeaturepurchase"
    )
    op.drop_index(
        op.f("ix_premiumfeaturepurchase_feature_id"),
        table_name="premiumfeaturepurchase",
    )
    ...
    op.drop_index(
        op.f("ix_factcheckcomment_fact_check_id"), table_name="factcheckcomment"
    )
    ...
    op.drop_index(
        op.f("ix_conversationparticipant_user_id"), table_name="conversationparticipant"
    )
    op.drop_index(
        op.f("ix_conversationparticipant_id"), table_name="conversationparticipant"
    )
    op.drop_index(
        op.f("ix_conversationparticipant_conversation_id"),
        table_name="conversationparticipant",
    )
    ...
    op.drop_index(
        op.f("ix_storyinteraction_interaction_type"), table_name="storyinteraction"
    )
    ...
    op.drop_table("news")
    op.drop_index(
        op.f("ix_moderationappeal_appellant_id"), table_name="moderationappeal"
    )
    ...
    op.drop_index(
        op.f("ix_notificationpreference_user_id"), table_name="notificationpreference"
    )
    op.drop_index(
        op.f("ix_notificationpreference_id"), table_name="notificationpreference"
    )
    ...
    op.drop_index(
        op.f("ix_moderationaction_moderator_id"), table_name="moderationaction"
    )
    op.drop_index(op.f("ix_moderationaction_content_id"), table_name="moderationaction")
    op.drop_table("moderationaction")
    op.drop_index(
        op.f("ix_mediaprocessingjob_media_file_id"), table_name="mediaprocessingjob"
    )
    op.drop_index(op.f("ix_mediaprocessingjob_id"), table_name="mediaprocessingjob")
    op.drop_index(
        op.f("ix_mediaprocessingjob_created_at"), table_name="mediaprocessingjob"
    )
    ...
    op.drop_index(
        op.f("ix_contentrecommendation_user_id"), table_name="contentrecommendation"
    )
    op.drop_index(
        op.f("ix_contentrecommendation_content_id"), table_name="contentrecommendation"
    )
    ...
    op.drop_index(
        op.f("ix_platformanalytics_week_start"), table_name="platformanalytics"
    )
    op.drop_index(
        op.f("ix_platformanalytics_month_start"), table_name="platformanalytics"
    )
    op.drop_index(op.f("ix_platformanalytics_id"), table_name="platformanalytics")
    op.drop_index(
        op.f("ix_platformanalytics_date_recorded"), table_name="platformanalytics"
    )
    ...
    op.drop_index(
        op.f("ix_engagementprediction_content_id"), table_name="engagementprediction"
    )
    ...
    op.drop_index(
        op.f("ix_contentclassification_content_id"), table_name="contentclassification"
    )
    op.drop_table("contentclassification")
    op.drop_index(op.f("ix_contentanalytics_id"), table_name="contentanalytics")
    op.drop_index(
        op.f("ix_contentanalytics_date_recorded"), table_name="contentanalytics"
    )
    op.drop_index(
        op.f("ix_contentanalytics_content_type"), table_name="contentanalytics"
    )
    op.drop_index(op.f("ix_contentanalytics_content_id"), table_name="contentanalytics")
    op.drop_index(
        op.f("ix_contentanalytics_content_created_at"), table_name="contentanalytics"
    )
