...
def upgrade():
    ...
    sa.Column('token_type', sa.Enum('access', 'refresh', 'password_reset', 'email_verification', 'api', name='tokentype'), nullable=False),
    ...
    op.create_index(op.f('ix_closefriend_friend_id'), 'closefriend', ['friend_id'], unique=False)
    op.create_index(op.f('ix_closefriend_id'), 'closefriend', ['id'], unique=False)
    op.create_index(op.f('ix_closefriend_user_id'), 'closefriend', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_emailverificationtoken_email'), 'emailverificationtoken', ['email'], unique=False)
    op.create_index(op.f('ix_emailverificationtoken_id'), 'emailverificationtoken', ['id'], unique=False)
    op.create_index(op.f('ix_emailverificationtoken_token'), 'emailverificationtoken', ['token'], unique=False)
    ...
    sa.Column('education', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    ...
    sa.Column('youtube_url', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('portfolio_url', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('professional_website', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    ...
    op.create_table('securitylog',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=True),
    sa.Column('event_type', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('event_status', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False),
    ...
    op.create_index(op.f('ix_securitylog_user_id'), 'securitylog', ['user_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('active', 'expired', 'revoked', 'blacklisted', name='tokenstatus'), nullable=False),
    sa.Column('expires_at', sa.DateTime(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('last_used_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('backup_codes', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True),
    ...
    op.create_index(op.f('ix_usercredentials_user_id'), 'usercredentials', ['user_id'], unique=True)
    op.create_table('verificationrequest',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('verification_type', sa.Enum('journalist', 'organization', 'business', name='verificationtype'), nullable=False),
    sa.Column('status', sa.Enum('pending', 'under_review', 'approved', 'rejected', 'expired', name='verificationstatus'), nullable=False),
    ...
    sa.Column('phone_number', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True),
    sa.Column('identification_document_url', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True),
    sa.Column('articles_of_incorporation_url', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True),
    sa.Column('official_website_url', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    ...
    sa.Column('review_notes', sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=True),
    ...
    op.create_index(op.f('ix_verificationrequest_user_id'), 'verificationrequest', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_profileview_profile_id'), 'profileview', ['profile_id'], unique=False)
    op.create_index(op.f('ix_profileview_viewed_at'), 'profileview', ['viewed_at'], unique=False)
    op.create_index(op.f('ix_profileview_viewer_id'), 'profileview', ['viewer_id'], unique=False)
    op.create_table('verificationbadge',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('verification_request_id', sa.Uuid(), nullable=False),
    sa.Column('badge_type', sa.Enum('journalist', 'organization', 'business', name='verificationtype'), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['verification_request_id'], ['verificationrequest.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_verificationbadge_id'), 'verificationbadge', ['id'], unique=False)
    op.create_index(op.f('ix_verificationbadge_user_id'), 'verificationbadge', ['user_id'], unique=False)
    op.drop_constraint(op.f('externalnewsarticle_source_id_fkey'), 'externalnewsarticle', type_='foreignkey')
    op.create_foreign_key(None, 'externalnewsarticle', 'integrationnewssource', ['source_id'], ['id'])
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'externalnewsarticle', type_='foreignkey')
    op.create_foreign_key(op.f('externalnewsarticle_source_id_fkey'), 'externalnewsarticle', 'newssource', ['source_id'], ['id'])
    ...
    op.drop_index(op.f('ix_verificationrequest_user_id'), table_name='verificationrequest')
    ...
    op.drop_index(op.f('ix_emailverificationtoken_email'), table_name='emailverificationtoken')
